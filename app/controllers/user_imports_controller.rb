class UserImportsController < ApplicationController
  ...
  def create
    ...
    if @user_import.save(current_user.id)      
      ...
      @point.save!
      flash[:success] = "Import success! You've just earned 30 points toward #{ActionController::Base.helpers.link_to "winning", contest_path} an Advocacy Award!".html_safe
