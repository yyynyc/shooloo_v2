...
resources :posts, path: '/common-core-math-word-problems' do
  ...
  match '/corrected', to: 'posts#corrected'
end
...
resources :hstandards
  ...
  match '/signup_child', to: 'users#signup_child', as: :signup_child
  ...
  get '/standards/common-core-math-I-can-high-school-number', to: "standards#hs_number", as: :hs_number
